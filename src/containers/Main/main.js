...
import { Navbar,Button,Nav,Form,
    FormControl,ListGroup,Col,Row,Container, NavItem } from 'react-bootstrap';
    ...
    render(){
        return (
            ...
            <Navbar bg="dark" variant="dark">
                ...
                <Form inline>
                <Button variant="secondary"  className="mr-sm-2" onClick={this.onaddSite} ><IoMdApps /></Button>
